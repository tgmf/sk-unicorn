...
export default {
  data() {
    ...
    return {
      stages: [ 
        {n: 0, q:"У вас есть идея, но нет<br/>денег — надо решить,<br/>кто из знакомых сможет вложиться в вас?", a: [{title:"Знакомый из универа", description:"Он не особо понимает в чем дело, но у него богатые родители", delta:300000, effect:"", step:1}, {title:"Отец", description:"У него есть свой бизнес, он поймет", delta:100000, effect:"", step:1 }, {title:"Бывший одноклассник", description:"Он вроде инвестирует в криптовалюты,<br/>может и&nbsp;в&nbsp;меня поверит", delta:0, effect:"", step:1 }]},
        {n: 1, q:"Ну вот, хоть какие-то деньги есть. Теперь надо подумать, где локализовать офис", a: [{title:"Технопарк «Сколково»", description:"", delta:300000, effect:"", step: 1}, {title:"Попробуем снять небольшой офис в центре", description:"", delta:-10000, effect:"", step: 2}, {title:"А зачем офис?", description:"Зарегистрирую компанию на какой-то юр адрес, а работать будем удаленно", delta:0, effect:"", step: 2 }]},
        {n: 2, q:"Сегодня ваш первый день в Технопарке «Сколково».<br/>Что будете делать?", a: [{title:"Выложу фото в соцсети с отметкой", description:"", delta:50000, effect:"", step: 1}, {title:"Пойду познакомлюсь с соседями — говорят, тут крутой нетворкинг", description:"", delta:200000, effect:"", step: 1}, {title:"Мой новый дом!<br/>Я больше никуда не выйду отсюда", description:"", delta:100000, effect:"", step: 1}]},
        {n: 3, q:"Готов MVP. Что будете с&nbsp;ним делать?", a: [{title:"Покажу на всякий случай профессионалам", description:"", delta:100000, effect:"", step: 1}, {title:"Ну тут сразу видны недочеты, пойдем на доработку", description:"", delta:0, effect:"", step: 1}, {title:"Запустим маленькую партию", description:"", delta:10000, effect:"", step: 1}]},
        {n: 4, q:"Тут в соцсетях запостили приглашение поучаствовать в&nbsp;акселераторе.<br/>Что же выбрать?", a: [{title:"Сяду, подготовлюсь", description:"", delta:200000, effect:"", step: 1}, {title:"Ладно, подамся, но напишу<br/>заявку кое-как", description:"", delta:100000, effect:"", step: 1}, {title:"Не буду тратить свое время", description:"", delta:0, effect:"", step: 2}]},
        {n: 5, q:"Вы повысили экспертизу и&nbsp;прокачали стартап. Пора искать специалистов для реализации. Что будете делать?", a: [{title:"Зарегаюсь и&nbsp;размещу заказ на&nbsp;Sk&nbsp;RND&nbsp;Market", description:"", delta:300000, effect:"", step: 1}, {title:"Буду искать исполнителей в&nbsp;интернете", description:"", delta:100000, effect:"", step: 1}, {title:"Привлеку знакомых, может, удастся сделать дешевле", description:"", delta:-50000, effect:"", step: 1}]},
        {n: 6, q:"Вы тщательно исследовали рынок и&nbsp;задумались над тем, чтобы учесть дополнительные потребностей аудитории.<br/>Что решите?", a: [{title:"Разрабатываем новые фичи", description:"Чем больше «болей» клиентов закроет наш продукт, тем лучше.", delta:-50000, effect:"", step: 1}, {title:"Серьезные доработки отбросят нас на несколько шагов назад", description:"Но что-то из пожеланий аудитории все же учтем", delta:200000, effect:"", step: 1}, {title:"У нас классный продукт", description:"Не будем ничего менять", delta:200000, effect:"", step: 1}]},
        {n: 7, q:"Ваш друг — он тоже в вашей команде — решил позвать друга в компанию. Не сказать, что его товарищ — суперспециалист,<br/>но&nbsp;человек хороший. Берем?", a: [{title:"Конечно!", description:"Надо помогать всем!", delta:-50000, effect:"", step: 1}, {title:"Мимо!", description:"Не бывает профессии «хороший человек»", delta:100000, effect:"", step: 1}, {title:"Отправим на тестовый период", description:"Вдруг он проявит себя?", delta:100000, effect:"", step: 1}]},
        {n: 8, q:"Вы не очень здорово пообщались с&nbsp;конкурентом, и&nbsp;он «натравил» на вас проверку. Пришла налоговая и&nbsp;попросила отчетность за все периоды работы. Слава богу вашей компании меньше года… ", a: [{title:"А чего мне бояться, у меня все прозрачно", description:"", delta:300000, effect:"", step: 1}, {title:"Сейчас главное выиграть время", description:"Заполню какую-никакую декларацию, потом найду специалистов, чтобы помогли с уточненкой", delta:100000, effect:"", step: 1}, {title:"Попробую наладить отношения с&nbsp;конкурентом", description:"Может, поможет отвадить налоговую", delta:-100000, effect:"", step: 1}]},
        {n: 9, q:"Ваши старания начинают видеть: вы получаете приглашение на Startup&nbsp;Village в&nbsp;качестве спикера.<br/>Что будете делать?", a: [{title:"Отличная возможность рассказать про мой продукт", description:"Подготовлю презентацию так, чтобы в&nbsp;ней было и&nbsp;про компанию, и про тему панели", delta:200000, effect:"", step: 1}, {title:"Ну ладно, в целом можно сходить", description:"Поболтаю с умными людьми, может кого встречу", delta:-100000, effect:"", step: 1}, {title:"Это что, надо отменять встречу в&nbsp;этот день?", description:"Не поеду никуда!", delta:-100000, effect:"", step: 1}]},
        {n: 10, q:"Ой-ой! Назревает ваш первый скандал: кто-то слил в&nbsp;социальные сети, как ваш сотрудник нелестно отзывается о&nbsp;продукте", a: [{title:"Ну и что?", description:"Любой пиар есть пиар! Будем делать вид, что так и&nbsp;должно быть", delta:-50000, effect:"", step: 1}, {title:"Надо срочно разослать комментарии в&nbsp;СМИ", description:"Покажем, что нам небезразлична эта ситуация", delta:100000, effect:"", step: 1}, {title:"Не было такого!", description:"Кто может обо мне плохо говорить?", delta:-100000, effect:"", step: 1}]},
        {n: 11, q:"На одном из мероприятий вы познакомились с&nbsp;потенциальными инвесторами, с&nbsp;первых слов им интересен проект. Надо запланировать полноценный питч с&nbsp;ними", a: [{title:"Созвонимся по видеосвязи", description:"Мы все же в&nbsp;21&nbsp;веке живем", delta:-10000, effect:"", step: 1}, {title:"Приглашу всех в&nbsp;модный ресторан", description:"Чтобы впечатлить выбором", delta:-50000, effect:"", step: 1}, {title:"Проведу встречу", description:"В Коворкинге&nbsp;2.0 в&nbsp;Технопарке&nbsp;“Сколково”", delta:200000, effect:"", step: 1}]},
        {n: 12, q:"Ура! Вы получили первые крупные инвестиции", a: [{title:"Вложусь в&nbsp;технологии для продукта", description:"", delta:300000, effect:"", step: 1}, {title:"Увеличу оборот", description:"", delta:-100000, effect:"", step: 1}, {title:"Усилю маркетинг", description:"", delta:100000, effect:"", step: 1}]},
        {n: 13, q:"Компания растет — пора нанимать новых членов команды. Кого будете искать в&nbsp;первую очередь?", a: [{title:"HR", description:"", delta:100000, effect:"", step: 1}, {title:"Sales", description:"", delta:50000, effect:"", step: 1}, {title:"Ассистентку для себя", description:"Ну а что?", delta:0, effect:"", step: 1}]},
        {n: 14, q:"Количество недовольных клиентов растет — одна из партий оказалась с&nbsp;браком.<br/>Что будете делать?", a: [{title:"Попрошу Customer Support отработать каждого клиента", description:"", delta:-10000, effect:"", step: 1}, {title:"Быстро снимаем с&nbsp;продажи эту партию, извиняемся перед покупателями и лично даем комментарии в СМИ", description:"", delta:50000, effect:"", step: 1}, {title:"Сейчас быстро почистим отзывы и&nbsp;зальем положительных", description:"", delta:-100000, effect:"", step: 1}]},
        {n: 15, q:"Скандал утих, но имидж компании серьезно пострадал, и&nbsp;вы&nbsp;задумались о&nbsp;ребрендинге. Какую стратегию выберете?", a: [{title:"Найму топового маркетолога и хорошенько вложусь в&nbsp;ребрендинг", description:"", delta:300000, effect:"", step: 1}, {title:"Сделаю все по-быстрому, инхаус", description:"За месяц точно управлюсь", delta:-100000, effect:"", step: 1}, {title:"Нет, ребрендинг — это дорого", description:"Все как-нибудь само затихнет и&nbsp;забудется", delta:0, effect:"", step: 1}]},
        {n: 16, q:"К вам пришел знакомый и&nbsp;предлагает сделать коллаборацию. Звучит классно, и&nbsp;идею он запитчил неплохо.<br/>Мы в деле?", a: [{title:"Я за любую инициативу!", description:"", delta:400000, effect:"end", step: 1}, {title:"Ой нет, потом будет много мороки с&nbsp;дележкой, а&nbsp;я&nbsp;не люблю такие разговоры", description:"", delta:-50000, effect:"end", step: 1}, {title:"Обсужу все внутри и&nbsp;проведу дополнительную встречу с&nbsp;этим авантюристом", description:"", delta:200000, effect:"end", step: 1}]},
      ],
      currentStage: null,
      balance: 100,
      defaultBalance: 100,
